...
-- Clean-bootstrap baseline captured before the first tracked migration.
-- This migration version is already applied in production; the baseline runs only on fresh databases.
