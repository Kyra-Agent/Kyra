...
begin
  ...
  delete from public.telegram_processed_updates where true;
  delete from public.telegram_owner_link_consume_rate_limits where true;
  delete from public.telegram_owner_link_challenges where true;
  delete from public.telegram_chat_authorizations where true;
  delete from public.telegram_webhook_secrets where true;
  delete from public.telegram_sessions where true;
  delete from public.telegram_bot_token_secrets where true;
  delete from public.execution_results where true;
  delete from public.prepared_actions where true;
  delete from public.approval_requests where true;
  delete from public.wallet_policies where true;
  delete from public.chain_action_rate_limits where true;
  delete from public.activity_logs where true;
  delete from public.agent_instances where true;
