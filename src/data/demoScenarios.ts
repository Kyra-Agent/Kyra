...
export const demoScenarios: DemoScenario[] = [
  {
    ...
    lines: [
      ...
      "BASE-MCP approval request created",
  ...
  },
  {
    ...
    lines: [
      ...
      "BASE-MCP proof request simulated",
  ...
  },
  {
    ...
    approvalRequired: true,
    lines: [
      "NIRA-01 parsed intent: launch_prepare",
      "ASTRA-03 compiling metadata checklist",
      "NOVA-04 preparing launch monitor fields",
      "NYX-05 admin action policy required",
      "status: approval policy draft ready",
    ],
  },
];
