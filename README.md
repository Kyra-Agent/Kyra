...
| 8 | In progress: controlled live transaction Batch 7 |
...
Base Account approval, controlled submitter wiring, owner live-window activation lock, rollback readiness, and owner-only
result recording.
