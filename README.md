...
| 8 | In progress: controlled live transaction Batch 10 |
...
Base Account approval, controlled submitter wiring, owner live-window activation lock, runtime enablement preflight, rollback readiness, and owner-only
result recording.
