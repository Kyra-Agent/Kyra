...
| 8 | In progress: controlled live transaction Batch 17 |
...
Base Account approval, controlled submitter wiring, owner live-window activation lock, runtime enablement preflight, Base ETH gas readiness guard, result persistence hardening, funding UX hardening, low-value transaction readiness hardening, rollback readiness, and owner-only
result recording.
