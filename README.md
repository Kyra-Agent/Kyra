...
Base Account approval, controlled submitter wiring, owner live-window activation lock, runtime enablement preflight, Base ETH gas readiness guard, result persistence hardening, funding UX hardening, low-value submit request skeleton, rollback readiness, and owner-only
result recording.
