...
Base Account approval, controlled submitter wiring, owner live-window activation lock, runtime enablement preflight, Base ETH gas readiness guard, result persistence hardening, funding UX hardening, isolated low-value submitter gate, rollback readiness, and owner-only
result recording.
