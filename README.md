...
Base Account approval, controlled submitter wiring, owner live-window activation lock, runtime enablement preflight, Base ETH gas readiness guard, result persistence hardening, funding UX hardening, live balance and gas readiness, first controlled low-value live run, rollback readiness, and owner-only
result recording.
