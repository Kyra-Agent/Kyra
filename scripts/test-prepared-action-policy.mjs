...
try {
  ...
  const reviewInput = {
    ...
    valueSummary: "Fixed 0.0001 ETH self-transfer in this policy test.",
  };
  ...
  assertEquals(readyForOwnerReview.riskReview.status, "review_required");
  assert(
    readyForOwnerReview.riskReview.permissions.includes("token_spend"),
    "Positive-value owner transactions must remain explicitly classified as token spend.",
  );
