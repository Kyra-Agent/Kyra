...
for (const expected of [
  "Status: Batch 16 user-safe transaction policy hardening.",
...
for (const expected of [
  ...
  "user-safe transaction policy hardening",
]) {
  includes("README", readme, expected);
}

includes("context", context, "Controlled Live Transaction - in progress through Batch 16 user-safe transaction policy hardening.");
